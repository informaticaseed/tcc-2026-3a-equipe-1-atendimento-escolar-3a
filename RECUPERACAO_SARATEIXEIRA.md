...
3. O que é um Pull Request e por que ele é importante?->Um Pull Request é um pedido para juntar as alterações feitas no código com o projeto principal. Ele é importante porque permite que outras pessoas revisem o código antes de aprovar, ajudando a evitar erros e melhorar a qualidade do projeto.
   
5. O que é separação de camadas no código?
